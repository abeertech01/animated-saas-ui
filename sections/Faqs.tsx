  ...
  return (
    <section className="py-24">
      <div className="container">
        ...
        <h2 className="mx-auto mt-6 max-w-xl font-medium text-6xl text-center">
          Questions? We&apos;ve got{" "}
          <span className="text-lime-400">answers</span>
        </h2>
        <div className="flex flex-col gap-6 mx-auto mt-12 max-w-xl">
          {faqs.map((faq, faqIndex) => (
            <div
              key={faq.question}
              className="bg-neutral-900 p-6 border border-white/10 rounded-2xl"
            >
              <div
              ...
              >
                ...
                <svg
                  ...
                  className={twMerge(
                    "text-lime-400 transition duration-300 shrink-0 feather feather-plus",
